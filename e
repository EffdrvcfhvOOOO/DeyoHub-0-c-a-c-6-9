if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://79232541562443";
          Title = "DEYO HUB", 
      Text = "Welcome Deyo hub!"
  })
  ...
  wait(10)
      ...
      do
          local ui = game.CoreGui:FindFirstChild("DEYOHUBGUI")
          if ui then
              ui:Destroy()
          end
      end
      ...
      local ScreenGui = Instance.new("ScreenGui")
local Toggle = Instance.new("ImageButton") -- Change TextButton to ImageButton
...
Toggle.Image = "rbxassetid://79232541562443" -- Replace with the Decal ID
...
Toggle.MouseButton1Down:Connect(function()
  ...
  elseif placeId == 7449423635 then
      ...
      local Deyohub = library:AddWindow("Deyo hub | Bloxfruit!",Enum.KeyCode.RightControl)
      
      local Main = Deyohub:AddTab("Main","6026568198")
      local stus = Deyohub:AddTab("Auto Stats","7040410130")
      local tp = Deyohub:AddTab("Teleport","7044226690")
      local player = Deyohub:AddTab("Players(Soon)","7252023075")
  ...
  if not Old_World then
     local raid = Deyohub:AddTab("Raid","7251993295")
  if New_World then
  ...
  raid:AddToggle("Auto Law Raid",false,function(vu)
      ...
      local esp = Deyohub:AddTab("Esp","7251993295")
  ...
  function UpdateFruits()
      ...
      local df =Deyohub:AddTab("Deviil Fruit","7044284832")
  ...
  spawn(function()
      ...
      local buy = Deyohub:AddTab("Buy Item","7294901968")
  ...
  buy:AddLabel("Accessory")
     ...
     local set = Deyohub:AddTab("Setting","7040347038")
  set:AddLabel("Setting")
      set:AddButton("Credit By cristianoronaldo12905",function()
  end)
      set:AddButton("Copy link Deyo's Discord ",function()
      setclipboard("https://discord.gg/VSYbEkh2AK")
  end)
  ...
  wait(10)
      ...
      local ScreenGui = Instance.new("ScreenGui")
    local Toggle = Instance.new("ImageButton") -- Using ImageButton instead of TextButton
...
-- Set Image using your decal ID
    Toggle.Image = "rbxassetid://79232541562443"
...
Toggle.MouseButton1Down:Connect(function()
    ...
    game:GetService("VirtualInputManager"):SendKeyEvent(false, 305, false, game)
      ...
      --
      local RenUi = library:AddWindow("Deyo hub | King Legacy",Enum.KeyCode.RightControl)
      --
